...
module SiteKit
  module Templates
    ...
    class GuideBuilder # rubocop:disable Metrics/ClassLength
      ...
      def validate_guide!(record, template_index) # rubocop:disable Metrics/AbcSize,Metrics/CyclomaticComplexity,Metrics/PerceivedComplexity
        ...
        raise SiteKit::CatalogError, "Template guide targets must be unique: #{dups.sort.join(', ')}" unless dups.empty?
    ...
    class LibraryContext
      ...
      def guide
        @guide ||= SiteKit::Templates::GuideBuilder.new(
